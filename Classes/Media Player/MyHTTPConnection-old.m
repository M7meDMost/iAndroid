...
- (NSString *) createBrowseableIndex:(NSString *)path
{
	...
	[outdata appendFormat:@"<h1>Transporteer bestanden naar iPod Touch</h1>", server.name];
    [outdata appendString:@"<bq>Deze bestanden zijn opgeslagen op de iPod Touch:</bq>"];
	...
	if ([self supportsPOST:path withSize:0])
	{
		...
		[outdata appendString:@"<label>Upload bestand:<br>"];
